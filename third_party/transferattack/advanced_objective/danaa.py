...
class DANAA(MIFGSM):
    ...
    Example script:
        python main.py --input_dir ./path/to/data --output_dir adv_data/danaa/resnet50 --attack danaa --model=resnet50
        python main.py --input_dir ./path/to/data --output_dir adv_data/danaa/resnet50 --eval
    """
