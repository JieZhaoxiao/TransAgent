...
class FIA(MIFGSM):
    ...
    Example script:
        python main.py --input_dir ./path/to/data --output_dir adv_data/fia/resnet50 --attack fia --model=resnet50
        python main.py --input_dir ./path/to/data --output_dir adv_data/fia/resnet50 --eval
    """
