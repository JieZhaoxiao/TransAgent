...
class TRAP(MIFGSM):
    ...
    Example script:
        python main.py --input_dir ./path/to/data --output_dir adv_data/trap/resnet50 --attack trap --model=resnet50
        python main.py --input_dir ./path/to/data --output_dir adv_data/trap/resnet50 --eval
    """
