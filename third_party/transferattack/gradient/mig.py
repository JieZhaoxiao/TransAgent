...
class MIG(MIFGSM):
    ...
    Example script:
        python main.py --input_dir ./path/to/data --output_dir adv_data/mig/resnet50 --attack mig --model=resnet50
        python main.py --input_dir ./path/to/data --output_dir adv_data/mig/resnet50 --eval
    """
