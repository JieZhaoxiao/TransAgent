...
class DeCowA(MIFGSM):
    ...
    Example script:
        python main.py --input_dir ./path/to/data --output_dir adv_data/decowa/resnet50 --attack decowa --model=resnet50
        python main.py --input_dir ./path/to/data --output_dir adv_data/decowa/resnet50 --eval
    """
