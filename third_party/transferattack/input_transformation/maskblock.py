...
class MaskBlock(MIFGSM):
    ...
    Example script:
        python main.py --input_dir ./path/to/data --output_dir adv_data/maskblock/resnet50 --attack maskblock --model=resnet50
        python main.py --input_dir ./path/to/data --output_dir adv_data/maskblock/resnet50 --eval
    """
