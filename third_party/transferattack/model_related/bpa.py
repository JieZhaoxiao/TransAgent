...
class BPA(MIFGSM):
    ...
    Example script:
        python main.py --input_dir ./path/to/data --output_dir adv_data/bpa/resnet50 --attack bpa --model=resnet50
        python main.py --input_dir ./path/to/data --output_dir adv_data/bpa/resnet50 --eval
